...
public class ClienteController implements Serializable {
    ...
    @EJB private com.dnsoft.reservasmesas.controles.ClienteFacade ejbFacade;
    ...
    public List<Cliente> getItemsAvailableSelectOne() {
     ...
     public List<Cliente> getItemsOrderbyApellidoNombre() {
        return getFacade().findAllOrderByApellidoNombre();
    }
